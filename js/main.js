...
(function ($) {
    $.fn.filtermap = function (options) {
        ...
        var mapcontrol = new L.Control.Layers(cloudmaps, {}).setPosition("bottomleft").addTo(mymap);
    ...
    function buildmarkerlayer(options) {
        ...
        function renderMarkers() {
            ...
            for (var i = 0; i < markerdata.length; i++) {
                ...
                var marker = new L.Marker(new L.LatLng(getlat(a), getlng(a)), {
                    title: a[dashboard.config["item_main"]]
                });
    ...
    function buildgeojsonlayer(geojsondata, getlat, getlng) {
        ...
        function hoverin(e) {
            var layer = e.target;
            var infotemplate = "<div><h4>Municipality</h4> <b> {{ NAME_2 }} </b></div>";
            layer.setStyle({
                weight: 3,
                color: "#666",
                dashArray: "0"
